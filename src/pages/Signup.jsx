      ...
      }
      {
        ...
        <div className="login-wrapper">
          <form className="form" onSubmit={(e) => {
            ...
            <img src="/apexlivetradelogo3.png" alt="Apexlivecopytrade" className="signup-logo" onClick={() => {
              navigate('/')
            }} />
            <span class="subtitle">Get started with apexlivecopytrade, just create an account and enjoy the experience.</span>
